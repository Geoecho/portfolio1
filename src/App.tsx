...
function App() {
  ...
  return (
    <div className="min-h-screen bg-dark text-white selection:bg-primary selection:text-white overflow-x-hidden">
      ...
      <div className="pointer-events-none fixed inset-y-0 left-0 w-32 z-40 bg-gradient-to-r from-black/60 via-black/25 to-transparent hidden lg:block" />
      <div className="pointer-events-none fixed inset-y-0 right-0 w-32 z-40 bg-gradient-to-l from-black/60 via-black/25 to-transparent hidden lg:block" />
